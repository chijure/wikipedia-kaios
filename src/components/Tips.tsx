...
const ReadPopup: FunctionalComponent = ({ close, onSearchPopupSelected }) => {
  const content = {
...
const SearchPopup: FunctionalComponent = ({ close, onSwitchPopupSelected }) => {
  const content = {
...
const SwitchPopup: FunctionalComponent = ({ close, showAboutWikipediaPopup }) => {
  const content = {
...
const AboutPopup: FunctionalComponent = ({ close }) => {
  const content = {
